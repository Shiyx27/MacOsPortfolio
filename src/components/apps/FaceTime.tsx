...
const Sidebar = ({ state, onTake, onSave, onSelect, onExport }: SidebarProps) => {
  ...
  return (
    <div className="absolute w-74 h-full z-1 left-0 top-0 flex flex-col bg-zinc-900/85 backdrop-blur-xl">
      <div className="p-5 space-y-2.5 text-sm">
        ...
        <button
          className="flex-center space-x-1 w-full py-1 text-white rounded-md bg-indigo-600"
          onClick={onExport}
        >
          <span className="i-mdi:export text-base" />
      ...
      <Sidebar
        ...
        onExport={() => {
          try {
            ...
            a.href = url;
            a.download = "facetime-images.json";
